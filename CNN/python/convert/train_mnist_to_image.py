...
data_file = 'resources/MNIST_data/train-images-idx3-ubyte'  # 需要修改的路径
...
label_file = 'resources/MNIST_data/train-labels-idx1-ubyte'  # 需要修改的路径
...
datas_root = 'resources/MNIST_data/image/train'  # 需要修改的路径
