...
data_file = 'resources/MNIST_data/t10k-images-idx3-ubyte'  # 需要修改的路径
...
label_file = 'resources/MNIST_data//t10k-labels-idx1-ubyte'  # 需要修改的路径
...
datas_root = 'resources/MNIST_data/image/test'  # 需要修改的路径
